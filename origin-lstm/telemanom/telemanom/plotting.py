...
class Plotter:
    ...
    def plot_channel(self, channel_id, plot_train=False, plot_errors=True):
        ...
        y_hat_path = os.path.join('..', 'data', self.run_id, 'y_hat','{}.npy'.format(channel_id))
        smoothed_errors_path = os.path.join('..', 'data', self.run_id,'smoothed_errors','{}.npy'.format(channel_id))
        test_path = os.path.join('..', 'data', 'test', '{}.npy'.format(channel_id))
        train_path = os.path.join('..', 'data', 'train', '{}.npy'.format(channel_id))
        print(y_hat_path)
        print(smoothed_errors_path)
        print(test_path)
        print(train_path)
        ...
        if plot_train:
            train_df.iplot(kind='scatter', color='green', layout={'title': "Training Data"})
